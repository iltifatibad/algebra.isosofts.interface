        ...
        actionPlan: [
          {
            ...
            resources: parseInt(row.resources?.id) || parseInt(row.resources) || "",
            currency: "", 
    ...
    if (modalMode === "add") {
      if (!showAction) {
        ...
        const payload = {
          ...
          resources: parseInt(actionData.actionPlan[0]?.resources) || "",
          ...
          actionPlan: [
            {
              ...
              resources: parseInt(actionData.actionPlan[0].resources.id) || "",
              currency: "",
