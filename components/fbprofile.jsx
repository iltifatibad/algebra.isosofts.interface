...
import { fbHelpContent } from "./utils/helpContents.js";
  ...
  <div className="flex items-center gap-2.5">
    ...
    >
      ...
      />
              ...
              <div className="overflow-x-auto max-h-[75vh] overflow-y-auto">
                <table>
                  <FbHeaders activeHeader={activeHeader} />
                  <FbBody
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              {/* Sağ sütun */}
              <div className="group">
                <label className="block text-xs font-medium text-gray-500 mb-1.5 group-focus-within:text-blue-500 transition-colors">
...
{showDeleteModal && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm modal-overlay">
    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 border border-gray-100 modal-box">
      ...
      <HelpModal isOpen={showHelp} onClose={() => setShowHelp(false)} helpData={fbHelpContent} />
    </div>
  );
};
