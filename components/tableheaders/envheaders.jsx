    ...
    return (
      <thead>
        ...
        <tr className="h-[52px]">
          ...
          <th
            rowSpan={2}
            className="min-w-[160px] border-r border-white-500 sticky top-0 z-20 bg-blue-100"
          >
            Affected Receptors
          </th>
          <th
            rowSpan={2}
            className="min-w-[200px] border-r border-white-500 sticky top-0 z-20 bg-blue-100"
          >
            Existing Controls
          </th>
          ...
          <th
            colSpan={5}
            className="border-r border-white-500 sticky top-0 z-20 bg-blue-100"
            style={{ minWidth: 600 }}
          >
        ...
        <tr className="h-[48px]">
          {/* Initial */}
          <th className="min-w-[120px] border-r border-white-500 sticky top-[52px] z-20 bg-blue-200">
            Probability
          </th>
          <th className="min-w-[120px] border-r border-white-500 sticky top-[52px] z-20 bg-blue-200">
            Severity
