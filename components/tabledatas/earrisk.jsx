...
const getArchivedData = async () => {
  ...
  try {
    ...
    const response = await fetch(`/api/register/ea/all?status=archived&token=${token}`);
    if (!response.ok) {
...
const getDeletedData = async () => {
  ...
  try {
    const token = document.cookie.split("; ").find((r) => r.startsWith("auth_token="))?.split("=").slice(1).join("=") ?? "";
    const response = await fetch(`/api/register/ea/all?status=deleted&token=${token}`);
    if (!response.ok) {
...
const getAll = async () => {
  setLoading(true);
  const token = document.cookie.split("; ").find((r) => r.startsWith("auth_token="))?.split("=").slice(1).join("=") ?? "";
  fetch(`/api/register/ea/all?token=${token}`)
    .then((response) => {
      if (!response.ok) {
            ...
            <tr className="bg-gray-50 border-b-2 border-blue-200">
              ...
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  ...
                  onChange={e => setFilters(prev => ({...prev, "lineManager": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["esd"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "esd": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["appraisalType?.value"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "appraisalType?.value": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["appraisalDate"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "appraisalDate": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["nextAppraisalDate"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "nextAppraisalDate": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["_daysLeft"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "_daysLeft": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              ...
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["tca"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "tca": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["skillsAppraisal"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "skillsAppraisal": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["jobQuality"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "jobQuality": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["leadershipSkills"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "leadershipSkills": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["managementSkills"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "managementSkills": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["behavioralSkills"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "behavioralSkills": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
              <td className="border border-gray-200 px-1 py-1 bg-gray-50 min-w-[60px]">
                <input
                  value={filters["effectivenessOfTrainings"] || ""}
                  onChange={e => setFilters(prev => ({...prev, "effectivenessOfTrainings": e.target.value}))}
                  placeholder="Filter..."
                  className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:border-blue-400"
                />
              </td>
...
<td className="border border-gray-200 px-2 py-1 w-20" rowSpan={1}>
  <SoftBadge value={row.employeeName} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Position */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.position} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Line Manager */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.lineManager} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* ESD */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.esd} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Appraisal Type */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.appraisalType?.value} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Appraisal Date */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.appraisalDate} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Next Appraisal Date */}
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  <SoftBadge value={row.nextAppraisalDate} color="bg-gray-100 text-black border border-gray-200" />
</td>
...
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  {(() => {
    if (!row.nextAppraisalDate) return (
      <SoftBadge value="No" color="bg-gray-100 text-black border border-gray-200" />
    );
...
<td className="border border-gray-200 px-2 py-1 w-32" rowSpan={1}>
  {(() => {
    ...
    const diffInDays = Math.ceil((new Date(row.nextAppraisalDate) - new Date()) / (1000 * 60 * 60 * 24));
    const isValid = diffInDays >= 0;
    return (
      <SoftBadge
...
{/* TCA */}
<td className="border border-gray-200 px-2 py-1 w-20" rowSpan={1}>
  <SoftBadge value={row.tca} color="bg-gray-100 text-black border border-gray-200" />
</td>

{/* Skills Appraisal */}
<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.skillsAppraisal} color="bg-gray-100 text-black border border-gray-200" />
</td>

<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.jobQuality} color="bg-gray-100 text-black border border-gray-200" />
</td>

<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.leadershipSkills} color="bg-gray-100 text-black border border-gray-200" />
</td>

<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.managementSkills} color="bg-gray-100 text-black border border-gray-200" />
</td>

<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.behavioralSkills} color="bg-gray-100 text-black border border-gray-200" />
</td>

<td className="border border-gray-200 px-2 py-1 w-24" rowSpan={1}>
  <SoftBadge value={row.effectivenessOfTrainings} color="bg-gray-100 text-black border border-gray-200" />
</td>
